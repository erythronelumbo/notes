...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 40|sgt-d  |uleq-d |sleq-d |ugeq-d |sgeq-d |sxt-bd |sxt-hd |sxt-wd |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 72|sgt-w  |uleq-w |sleq-w |ugeq-w |sgeq-w |sxt-bw |sxt-hw |trc-w  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|104|sgt-h  |uleq-h |sleq-h |ugeq-h |sgeq-h |sxt-bh |...    |trc-h  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|136|sgt-b  |uleq-b |sleq-b |ugeq-b |sgeq-b |...    |...    |trc-b  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|168|grab-3 |grab-4 |grab-5 |grab-6 |grab-7 |grab-8 |dup-t  |grab-t |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|176|swap-1 |swap-2 |swap-3 |swap-4 |swap-5 |swap-6 |swap-7 |swap-8 |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|184|bury-3 |bury-4 |bury-5 |bury-6 |bury-7 |bury-8 |swap-t |bury-t |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|192|ddup-1 |ddup-2 |ddup-3 |ddup-4 |dgrab-3|dgrab-4|ddup-t |dgrab-t|
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|200|dswap-1|dswap-2|dswap-3|dswap-4|dbury-3|dbury-4|dswap-t|dbury-t|
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|208|lit    |pop    |dpop   |pickif |...    |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|216|...    |...    |...    |...    |...    |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|224|fadd-d |fsub-d |fmul-d |fdiv-d |fneg-d |feq-d  |fneq-d |fgt-d  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|232|flt-d  |fgeq-d |fleq-d |ffun-d |fcnv-d |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|240|fadd-w |fsub-w |fmul-w |fdiv-w |fneg-w |feq-w  |fneq-w |fgt-w  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|248|flt-w  |fgeq-w |fleq-w |ffun-w |fcnv-w |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
```

- `ffun-{d/w}` are *prefixes* for the following functions:
  ```
  +-----+----+
  |Name |Hex |
  +-----+----+
  ...
  +-----+----+
  ```
- `fcnv-{d/w}` are *prefixes* for conversions between floating-point and
  integral values:
  ```
  +---------+----+
  |Name     |Hex |
  ...
  |to-b     |0x03|
  +---------+----+
  |to-{w/d}f|0x04| <-- `to-wf` (single-precision) if preceded by `fcnv-d`
  +---------+----+     `to-df` (double-precision)  "     "     " `fcnv-w`
  ```


Bytecode table - alternative:
```
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|\\\|  +0   |  +1   |  +2   |  +3   |  +4   |  +5   |  +6   |  +7   |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
| 32|smod-d |eq-d   |neq-d  |isz-d  |isnz-d |ult-d  |slt-d  |ugt-d  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 40|sgt-d  |uleq-d |sleq-d |ugeq-d |sgeq-d |ifun-d |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 48|and-w  |or-w   |xor-w  |not-w  |sll-w  |slr-w  |sar-w  |inc-w  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 56|dec-w  |add-w  |sub-w  |neg-w  |mul-w  |udiv-w |sdiv-w |umod-w |
...
| 64|smod-w |eq-w   |neq-w  |isz-w  |isnz-w |ult-w  |slt-w  |ugt-w  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 72|sgt-w  |uleq-w |sleq-w |ugeq-w |sgeq-w |ifun-w |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 80|and-h  |or-h   |xor-h  |not-h  |sll-h  |slr-h  |sar-h  |inc-h  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
| 88|dec-h  |add-h  |sub-h  |neg-h  |mul-h  |udiv-h |sdiv-h |umod-h |
...
| 96|smod-h |eq-h   |neq-h  |isz-h  |isnz-h |ult-h  |slt-h  |ugt-h  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|104|sgt-h  |uleq-h |sleq-h |ugeq-h |sgeq-h |ifun-h |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|112|and-b  |or-b   |xor-b  |not-b  |sll-b  |slr-b  |sar-b  |inc-b  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|120|dec-b  |add-b  |sub-b  |neg-b  |mul-b  |udiv-b |sdiv-b |umod-b |
...
|128|smod-b |eq-b   |neq-b  |isz-b  |isnz-b |ult-b  |slt-b  |ugt-b  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|136|sgt-b  |uleq-b |sleq-b |ugeq-b |sgeq-b |ifun-b |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|144|sxt-bh |sxt-bw |sxt-bd |sxt-hw |sxt-hd |sxt-wd |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|152|trc-b  |trc-h  |trc-w  |...    |...    |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|160|ld-d   |ld-w   |ld-h   |ld-b   |ldi-d  |ldi-w  |ldi-h  |ldi-b  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|168|st-d   |st-w   |st-h   |st-b   |sti-d  |sti-w  |sti-h  |sti-b  |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
...
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|208|ddup-1 |ddup-2 |ddup-3 |ddup-4 |dgrab-3|dgrab-4|ddup-t |dgrab-t|
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|216|dswap-1|dswap-2|dswap-3|dswap-4|dbury-3|dbury-4|dswap-t|dbury-t|
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|224|pop-1  |pop-2  |pop-3  |pop-4  |lit    |pickif |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|232|...    |...    |...    |...    |...    |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|240|fops-w |fcmp-d |fcnv-d |ffun-d |fops-w |fcmp-w |fcnv-w |ffun-w |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
|248|...    |...    |...    |...    |...    |...    |...    |...    |
+---+-------+-------+-------+-------+-------+-------+-------+-------+
```
