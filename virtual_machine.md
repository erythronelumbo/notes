...
|216|...   |...   |...   |...   |...   |...   |...   |...   |
+---+------+------+------+------+------+------+------+------+
|224|fadd-w|fsub-w|fmul-w|fdiv-w|fneg-w|feq-w |fneq-w|fgt-w |
+---+------+------+------+------+------+------+------+------+
|232|flt-w |fgeq-w|fleq-w|...   |...   |...   |...   |...   |
+---+------+------+------+------+------+------+------+------+
|240|fadd-d|fsub-d|fmul-d|fdiv-d|fneg-d|feq-d |fneq-d|fgt-d |
+---+------+------+------+------+------+------+------+------+
|248|flt-d |fgeq-d|fleq-d|...   |...   |...   |...   |...   |
+---+------+------+------+------+------+------+------+------+
```
